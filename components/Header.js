...
function Header({placeholder}) {
    ...
    return(
        <header className={'sticky top-0 z-50 grid grid-cols-3 bg-[#f7f7f7] shadow-md p-5 md:px-10 '}>
            ...
            {/*Middle*/}
            <div className={'flex bg-white items-center md:border-2 rounded-full py-2 md:shadow-lg text-sm text-gray-900'}>
                <input type={'text'}
            ...
            {searchInput && (
                <div className={'flex flex-col col-span-3 mt-2 mx-auto'}>
                    <DateRangePicker
